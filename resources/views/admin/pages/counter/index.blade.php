...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Counter Tables</h3>
                    <ul class="breadcrumb">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 data_table">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($counter_data as $counter)
                                    
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>{{$counter->title}}</td>
                                        <td>{{$counter->projectNumber}}</td>
                                        <td><i class="{{$counter->icon}}"></i></td>
                                        <td>{{$counter->created_at-> diffForHumans()}}</td>
                                        @if ($counter->status)
                                        <td>
                                            <span class="badge badge-pill badge-success">Published</span> <a class="btn btn-sm btn-dark" style="color: red;" href="{{route('counter.status.update', $counter->id)}}"><i class="fa fa-times btn_alert"></i></a>
                                        </td>
                                        @else
                                        <td>
                                            <span class="badge badge-pill badge-danger">Unpublished</span> <a class="btn btn-sm btn-light" style="color:green" href="{{route('counter.status.update', $counter->id)}}"><i class="fa fa-check"></i></a>
                                        </td>
                                        @endif
                                        ...
                                        <td style="display: flex;">
                                            <a style="margin-right: 2px" class="btn btn-warning" href="{{route('counter.edit', $counter->id)}}"><i class="fa fa-edit"></i></a>
                                            <form  action="{{route('counter.destroy', $counter->id)}}" class="delete-form" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('counter.store')}}" method="POST" >
                            ...
                            <div class="form-group">
                                ...
                                <input name="projectNumber" type="text" class="form-control" value="{{old('projectNumber')}}">
                            </div>

                            <div class="form-group">
                                <label> Icon</label><br><br>
                                <button class="brn brn-sm btn-info show-icon">Select Icon</button><br>
                                <input name="icon" type="text" class="form-control icon_name_field" value="{{old('icon')}}">
                            </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('counter.update' , $edit_id->id)}}" method="POST" >
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label>  Title </label>
                            ...
                            <div class="form-group">
                                <label> Total Project </label>
                                <input name="projectNumber" type="text" class="form-control" value="{{$edit_id->projectNumber}}">
                            </div>

                            <div class="form-group">
                                <label> Icon</label><br>
                                <button class="brn brn-sm btn-info show-icon">Select Icon</button><br>
                                <input name="icon" type="text" class="form-control icon_name_field" value="{{$edit_id->icon}}">
                            </div>
...
{{-- icon model  --}}
<div id="select_icon_page" class="modal fade">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body">

                <div  class="row icon_page_row">
