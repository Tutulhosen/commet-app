 ...
 */
 ...
 Route::group(['middleware' =>'admin'], function(){
  ...
  //post tag route
  Route::resource('/tagpost', TagpostController::class);
  Route::get('/tagpost-status-update/{id}', [TagpostController::class, 'tagpostStatusUpdate'])->name('tagpost.status.update');
